    ...
    public sealed class GUIListView : GUIFocusableObject
    {
        ...
        public void Select(string ListViewItem)
        {
            ...
            for (int Item = 0; Item < Items; Item++)
            {
                ...
                if (ItemText == ListViewItem)
                {
                    ...
                    GUI.m_APE.AddMessageQueryMember(APEIPC.DataStores.Store0, APEIPC.DataStores.Store1, "Items", MemberTypes.Property);
                    GUI.m_APE.AddMessageQueryMember(APEIPC.DataStores.Store1, APEIPC.DataStores.Store2, "Item", MemberTypes.Property, new APEIPC.Parameter(GUI.m_APE, Item));
                    GUI.m_APE.AddMessageQueryMember(APEIPC.DataStores.Store2, APEIPC.DataStores.Store3, "EnsureVisible", MemberTypes.Method);
                    GUI.m_APE.AddMessageQueryMember(APEIPC.DataStores.Store2, APEIPC.DataStores.Store4, "Index", MemberTypes.Property);
                    ...
                    do
                    {
                        ...
                        GUI.m_APE.AddMessageQueryMember(APEIPC.DataStores.Store0, APEIPC.DataStores.Store1, "Items", MemberTypes.Property);
                        GUI.m_APE.AddMessageQueryMember(APEIPC.DataStores.Store1, APEIPC.DataStores.Store2, "Item", MemberTypes.Property, new APEIPC.Parameter(GUI.m_APE, Item));
                        GUI.m_APE.AddMessageQueryMember(APEIPC.DataStores.Store2, APEIPC.DataStores.Store3, "Selected", MemberTypes.Property);
                        GUI.m_APE.AddMessageGetValue(APEIPC.DataStores.Store3);
                        GUI.m_APE.SendMessages(APEIPC.EventSet.APE);
                        GUI.m_APE.WaitForMessages(APEIPC.EventSet.APE);
                        // Get the value(s) returned MUST be done straight after the WaitForMessages call
        ...
        public void SelectGroup(string ListViewGroup)
        {
            ...
            if (ListViewGroup == "<Default>")
            {
                ...
                GUI.m_APE.AddMessageFindByHandle(APEIPC.DataStores.Store0, Identity.ParentHandle, Identity.Handle);
                GUI.m_APE.AddMessageQueryMember(APEIPC.DataStores.Store0, APEIPC.DataStores.Store1, "DefaultGroup", MemberTypes.Property);
                GUI.m_APE.AddMessageQueryMember(APEIPC.DataStores.Store1, APEIPC.DataStores.Store2, "ID", MemberTypes.Property);
                GUI.m_APE.AddMessageGetValue(APEIPC.DataStores.Store2);
                GUI.m_APE.SendMessages(APEIPC.EventSet.APE);
                GUI.m_APE.WaitForMessages(APEIPC.EventSet.APE);
                // Get the value(s) returned MUST be done straight after the WaitForMessages call
            ...
            {
                GUI.m_APE.AddMessageFindByHandle(APEIPC.DataStores.Store0, Identity.ParentHandle, Identity.Handle);
                GUI.m_APE.AddMessageQueryMember(APEIPC.DataStores.Store0, APEIPC.DataStores.Store1, "Groups", MemberTypes.Property);
                GUI.m_APE.AddMessageQueryMember(APEIPC.DataStores.Store1, APEIPC.DataStores.Store2, "Count", MemberTypes.Property);
                GUI.m_APE.AddMessageGetValue(APEIPC.DataStores.Store2);
                GUI.m_APE.SendMessages(APEIPC.EventSet.APE);
                GUI.m_APE.WaitForMessages(APEIPC.EventSet.APE);
                ...
                for (Group = 0; Group < Groups; Group++)
                {
                    ...
                    GUI.m_APE.AddMessageFindByHandle(APEIPC.DataStores.Store0, Identity.ParentHandle, Identity.Handle);
                    GUI.m_APE.AddMessageQueryMember(APEIPC.DataStores.Store0, APEIPC.DataStores.Store1, "Groups", MemberTypes.Property);
                    GUI.m_APE.AddMessageQueryMember(APEIPC.DataStores.Store1, APEIPC.DataStores.Store2, "Item", MemberTypes.Property, new APEIPC.Parameter(GUI.m_APE, Group));
                    GUI.m_APE.AddMessageQueryMember(APEIPC.DataStores.Store2, APEIPC.DataStores.Store3, "Header", MemberTypes.Property);
                    GUI.m_APE.AddMessageQueryMember(APEIPC.DataStores.Store2, APEIPC.DataStores.Store4, "ID", MemberTypes.Property);
                    GUI.m_APE.AddMessageGetValue(APEIPC.DataStores.Store3);
                    GUI.m_APE.AddMessageGetValue(APEIPC.DataStores.Store4);
                    GUI.m_APE.SendMessages(APEIPC.EventSet.APE);
                    GUI.m_APE.WaitForMessages(APEIPC.EventSet.APE);
                    ...
                    if (Text == ListViewGroup)
                    {
                        ...
                        GUI.m_APE.AddMessageQueryMember(APEIPC.DataStores.Store0, APEIPC.DataStores.Store1, "Groups", MemberTypes.Property);
                        GUI.m_APE.AddMessageQueryMember(APEIPC.DataStores.Store1, APEIPC.DataStores.Store2, "Item", MemberTypes.Property, new APEIPC.Parameter(GUI.m_APE, Group));
                        GUI.m_APE.AddMessageQueryMember(APEIPC.DataStores.Store2, APEIPC.DataStores.Store3, "Items", MemberTypes.Property);
                        GUI.m_APE.AddMessageQueryMember(APEIPC.DataStores.Store3, APEIPC.DataStores.Store4, "Item", MemberTypes.Property, new APEIPC.Parameter(GUI.m_APE, 0));
                        GUI.m_APE.AddMessageQueryMember(APEIPC.DataStores.Store4, APEIPC.DataStores.Store5, "EnsureVisible", MemberTypes.Method);
                        GUI.m_APE.AddMessageQueryMember(APEIPC.DataStores.Store4, APEIPC.DataStores.Store6, "Index", MemberTypes.Property);
            ...
            try
            {
                ...
                else
                {
                    ...
                    GUI.m_APE.AddMessageQueryMember(APEIPC.DataStores.Store1, APEIPC.DataStores.Store2, "Item", MemberTypes.Property, new APEIPC.Parameter(GUI.m_APE, Group));
                    GUI.m_APE.AddMessageQueryMember(APEIPC.DataStores.Store2, APEIPC.DataStores.Store3, "Items", MemberTypes.Property);
                    GUI.m_APE.AddMessageQueryMember(APEIPC.DataStores.Store3, APEIPC.DataStores.Store4, "Count", MemberTypes.Property);
                    GUI.m_APE.AddMessageGetValue(APEIPC.DataStores.Store4);
                    GUI.m_APE.SendMessages(APEIPC.EventSet.APE);
                    GUI.m_APE.WaitForMessages(APEIPC.EventSet.APE);
                    // Get the value(s) returned MUST be done straight after the WaitForMessages call
                    ...
                    do
                    {
                        for (int ItemInGroup = 0; ItemInGroup < ItemsInGroup; ItemInGroup++)
                        {
                            ...
                            GUI.m_APE.AddMessageQueryMember(APEIPC.DataStores.Store1, APEIPC.DataStores.Store2, "Item", MemberTypes.Property, new APEIPC.Parameter(GUI.m_APE, Group));
                            GUI.m_APE.AddMessageQueryMember(APEIPC.DataStores.Store2, APEIPC.DataStores.Store3, "Items", MemberTypes.Property);
                            GUI.m_APE.AddMessageQueryMember(APEIPC.DataStores.Store3, APEIPC.DataStores.Store4, "Item", MemberTypes.Property, new APEIPC.Parameter(GUI.m_APE, ItemInGroup));
                            GUI.m_APE.AddMessageQueryMember(APEIPC.DataStores.Store4, APEIPC.DataStores.Store5, "Selected", MemberTypes.Property);
        ...
        private bool[] GetDefaultGroupItems()
        {
            ...
            for (int Group = 0; Group < Groups; Group++)
            {
                ...
                for (int Item = 0; Item < Items; Item++)
                {
                    ...
                    GUI.m_APE.AddMessageQueryMember(APEIPC.DataStores.Store1, APEIPC.DataStores.Store2, "Item", MemberTypes.Property, new APEIPC.Parameter(GUI.m_APE, Group));
                    GUI.m_APE.AddMessageQueryMember(APEIPC.DataStores.Store2, APEIPC.DataStores.Store3, "Items", MemberTypes.Property);
                    GUI.m_APE.AddMessageQueryMember(APEIPC.DataStores.Store3, APEIPC.DataStores.Store4, "Item", MemberTypes.Property, new APEIPC.Parameter(GUI.m_APE, Item));
                    GUI.m_APE.AddMessageQueryMember(APEIPC.DataStores.Store4, APEIPC.DataStores.Store5, "Index", MemberTypes.Property);
                    GUI.m_APE.AddMessageGetValue(APEIPC.DataStores.Store5);
                    GUI.m_APE.SendMessages(APEIPC.EventSet.APE);
                    GUI.m_APE.WaitForMessages(APEIPC.EventSet.APE);
                    // Get the value(s) returned MUST be done straight after the WaitForMessages call
        ...
        public void Select(string ListViewGroup, string ListViewItem)
        {
            ...
            else
            {
                ...
                for (int Group = 0; Group < Groups; Group++)
                {
                    ...
                    GUI.m_APE.AddMessageQueryMember(APEIPC.DataStores.Store1, APEIPC.DataStores.Store2, "Item", MemberTypes.Property, new APEIPC.Parameter(GUI.m_APE, Group));
                    GUI.m_APE.AddMessageQueryMember(APEIPC.DataStores.Store2, APEIPC.DataStores.Store3, "Header", MemberTypes.Property);
                    GUI.m_APE.AddMessageQueryMember(APEIPC.DataStores.Store2, APEIPC.DataStores.Store4, "Items", MemberTypes.Property);
                    GUI.m_APE.AddMessageQueryMember(APEIPC.DataStores.Store4, APEIPC.DataStores.Store5, "Count", MemberTypes.Property);
                    GUI.m_APE.AddMessageGetValue(APEIPC.DataStores.Store3);
                    GUI.m_APE.AddMessageGetValue(APEIPC.DataStores.Store5);
                    GUI.m_APE.SendMessages(APEIPC.EventSet.APE);
                    GUI.m_APE.WaitForMessages(APEIPC.EventSet.APE);
                    ...
                    if (GroupHeader == ListViewGroup)
                    {
                        for (int Item = 0; Item < Items; Item++)
                        {
                            ...
                            GUI.m_APE.AddMessageQueryMember(APEIPC.DataStores.Store2, APEIPC.DataStores.Store3, "Items", MemberTypes.Property);
                            GUI.m_APE.AddMessageQueryMember(APEIPC.DataStores.Store3, APEIPC.DataStores.Store4, "Item", MemberTypes.Property, new APEIPC.Parameter(GUI.m_APE, Item));
                            GUI.m_APE.AddMessageQueryMember(APEIPC.DataStores.Store4, APEIPC.DataStores.Store5, "Text", MemberTypes.Property);
                            GUI.m_APE.AddMessageGetValue(APEIPC.DataStores.Store5);
                            GUI.m_APE.SendMessages(APEIPC.EventSet.APE);
                            GUI.m_APE.WaitForMessages(APEIPC.EventSet.APE);
                            // Get the value(s) returned MUST be done straight after the WaitForMessages call
                            ...
                            if (ItemText == ListViewItem)
                            {
                                ...
                                do
                                {
                                    GUI.m_APE.AddMessageFindByHandle(APEIPC.DataStores.Store0, Identity.ParentHandle, Identity.Handle);
                                    GUI.m_APE.AddMessageQueryMember(APEIPC.DataStores.Store0, APEIPC.DataStores.Store1, "Items", MemberTypes.Property);
                                    GUI.m_APE.AddMessageQueryMember(APEIPC.DataStores.Store1, APEIPC.DataStores.Store2, "Item", MemberTypes.Property, new APEIPC.Parameter(GUI.m_APE, Index));
                                    GUI.m_APE.AddMessageQueryMember(APEIPC.DataStores.Store2, APEIPC.DataStores.Store3, "Selected", MemberTypes.Property);
                                    GUI.m_APE.AddMessageGetValue(APEIPC.DataStores.Store3);
                                    GUI.m_APE.SendMessages(APEIPC.EventSet.APE);
                                    GUI.m_APE.WaitForMessages(APEIPC.EventSet.APE);
