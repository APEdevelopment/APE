...
namespace APE.Language
{
    ...
    public abstract class GUIToolStripObject
    {
        ...
        //    GUI.m_APE.WaitForMessages(APEIPC.EventSet.APE);
        //    // Get the value(s) returned MUST be done straight after the WaitForMessages call
        //    string Name = GUI.m_APE.GetValueFromMessage(1);
        //    string TypeNameSpace = GUI.m_APE.GetValueFromMessage(2);
        //    string TypeName = GUI.m_APE.GetValueFromMessage(3);
        //    string Text = GUI.m_APE.GetValueFromMessage(4);
        //    string ModuleName = GUI.m_APE.GetValueFromMessage(5);
        //    string AssemblyName = GUI.m_APE.GetValueFromMessage(6);
